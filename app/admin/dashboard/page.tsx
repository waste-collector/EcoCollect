                    ...
                    <CardContent className="space-y-3">
                        {alerts.length === 0 ? (
                            ...
                            alerts.map((alert, index) => (
                                <div
                                    key={index}
                                    className={`flex items-start gap-3 p-3 border rounded-lg ${alert.type === "critical"
                                ...
                                >
                                    ...
                                    <div>
                                        <p
                                            className={`font-medium ${alert.type === "critical"
                                        ...
                                        <p
                                            className={`text-sm ${alert.type === "critical"
